...
p <- ggplot(all_alf,
       aes(x = Alfalfa_early_log2FoldChange, 
           ...
           label = OTU)) +
  geom_miss_point() +
  geom_text_repel(aes(label=ifelse(Alfalfa_early_log2FoldChange>3 & Alfalfa_late_log2FoldChange>3,as.character(OTU),'')),hjust=1,vjust=1) +
...
These OTUs had response greater than 3 in both early and late mix   
...
## Plot relative abundance of OTUs with LFC > 3
```{r}
