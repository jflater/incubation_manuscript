...
```{r}
# Label all non responding OTUs as other for each treatment
# Plot abundance of OTUs plus other == 1.0
# X - axis will be time
# Experiment with faceting to show early and late? 
# Label band with OTU\Phyla\Genus
# Plot at least 3 for each treatment
