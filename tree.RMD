...
```{r}
PCoA <- ordinate(rare6k.physeq, "PCoA", "unifrac", weighted = T)
plot_ordination(rare6k.physeq, ord, color = "day", shape = "treatment")
```
```{r}
NMDS <- ordinate(rare6k.physeq, "NMDS", "unifrac", weighted = T)
